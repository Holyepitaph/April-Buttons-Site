...
function ParagraphSectionThree(){
    return(
        <div class="my-3.5">
            ...
            <h1 class="text-xl">Everyone gets more awesome.</h1>
...
function ButtonSectionThreeFirst({children}){
    return(
        <div>
            <button class=" border-4 bg-emerald-200 border-emerald-500 hover:border-emerald-800 rounded-xl 
            w-full hover:bg-emerald-400 shadow-[0_5px_#999] active:shadow-[0_3px_#999]
            active:translate-y-0.5 active:bg-emerald-300 active:border-emerald-700">{children}</button>
        </div>
    )
}
